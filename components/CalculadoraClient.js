  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900">
      ...
      <section className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="mx-auto max-w-3xl rounded-xl sm:rounded-2xl border border-slate-200 bg-white/95 p-4 sm:p-6 lg:p-8 shadow-lg">
          ...
          <h1 className="text-center mt-4 text-2xl sm:text-3xl font-bold tracking-tight text-slate-900 md:text-4xl leading-tight">
            Bathroom Remodel Cost Calculator
          </h1>

          <p className="text-center mt-4 text-xs sm:text-sm leading-5 sm:leading-6 text-slate-600 md:text-base">
      ...
      {/* WIZARD */}
      <section className="mx-auto max-w-6xl px-4 pb-8 sm:px-6 sm:pb-12 lg:px-8 lg:pb-16">
      ...
      <section className="border-t border-slate-200 bg-slate-100">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          <div className="grid gap-6 md:gap-8 lg:grid-cols-2 lg:items-start">
            ...
            <div className="rounded-2xl sm:rounded-3xl border border-slate-200 bg-white p-4 sm:p-6 shadow-lg">
              <p className="text-center text-xs sm:text-sm font-semibold text-slate-900">
                Thanks to{" "}
                <a
