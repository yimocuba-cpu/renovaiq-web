...
export default function BathroomRemodeling() {
  return (
    <main className="bg-white text-gray-900">
      <article className="mx-auto max-w-2xl px-6 py-12 sm:px-8 lg:px-10">
        {/* HEADER */}
        ...
        <section className="mb-12">
          ...
          <ul className="mt-6 space-y-4 text-base leading-8 text-gray-700 list-disc list-inside">
            <li className="pl-2">
        ...
        <section className="mb-12">
          ...
          <ul className="mt-6 space-y-5 text-base leading-8 text-gray-700">
        ...
        <section className="mb-12">
          ...
          <div className="mt-6 space-y-4">
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-5 hover:shadow-sm transition-shadow">
              <p className="font-semibold text-gray-900">Bathroom type</p>
              <p className="mt-2 text-sm leading-7 text-gray-700">
                Master bath &gt; guest bath &gt; powder room. Larger bathrooms cost more.
              </p>
            </div>
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-5 hover:shadow-sm transition-shadow">
              <p className="font-semibold text-gray-900">Geographic location</p>
              <p className="mt-2 text-sm leading-7 text-gray-700">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-5 hover:shadow-sm transition-shadow">
              <p className="font-semibold text-gray-900">Material quality</p>
              <p className="mt-2 text-sm leading-7 text-gray-700">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-5 hover:shadow-sm transition-shadow">
              <p className="font-semibold text-gray-900">Scope of work</p>
              <p className="mt-2 text-sm leading-7 text-gray-700">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-5 hover:shadow-sm transition-shadow">
              <p className="font-semibold text-gray-900">Contractor experience</p>
              <p className="mt-2 text-sm leading-7 text-gray-700">
        ...
        <section className="mb-12">
          ...
          <ol className="mt-6 space-y-5 list-decimal list-inside text-base leading-8 text-gray-700">
            <li className="pl-2">
        ...
        {/* CTA */}
        <section className="my-12 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 p-8 sm:p-10">
